    ...
    def monte_carlo(self, n_episodes=1000):
        for episode in range(n_episodes):
            ...
            for t in reversed(range(len(states)-1)):
                ...
                if state not in visited: #One time montecarlo
...
env = Environment({(0, 3): 10, (1, 3): -10}, gamma=0.9)
player = MonteFirstTime(start=(0,0), gamma=0.9, env=env)
